 ...
 */
 ...
 bool AP_GetMousePosition(double *x, double *y) {
   if (x == NULL || y == NULL) {
     AP_SET_ERROR(AP_ERROR_INVALID_ARGUMENT, "Mouse position out pointers are NULL");
     return false;
   }
 ...
 bool AP_GetMouseDelta(double *x, double *y) {
   if (x == NULL || y == NULL) {
     AP_SET_ERROR(AP_ERROR_INVALID_ARGUMENT, "Mouse delta out pointers are NULL");
     return false;
   }
 ...
 bool AP_GetMouseWheel(double *x, double *y) {
   if (x == NULL || y == NULL) {
     AP_SET_ERROR(AP_ERROR_INVALID_ARGUMENT, "Mouse wheel out pointers are NULL");
     return false;
   }
 ...
 void AP_ResetInput(void) {
   ...
   for (i = 0; i < AP_GAMEPAD_MAX; ++i) {
     memset(g_input.gamepads[i].buttons, 0,
