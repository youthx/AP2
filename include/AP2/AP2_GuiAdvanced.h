...
extern "C"
{
    ...
    /* Connect a callback to a signal (e.g., "clicked", "valueChanged", "textChanged") */
    ...
    typedef void (*AP_GuiCanvasRenderCallback)(AP_GuiWidget *canvas, AP_FRect bounds, void *user_data);
